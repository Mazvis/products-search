<div class="list-group-item">
    <p class="pull-left">{{ $textLikeTitle }}</p>
    <p class="text-hide pull-right">{{ json_encode($products) }}</p>
    <p>.</p>
</div>
    ...
    <div class="col-sm-4 col-lg-4 col-md-4" style="padding-top: 20px; cursor:pointer;" onclick="location.href='{{$product->deepLink}}';">
        <div class="thumbnail">
            ...
            <div class="ratings">
                ...
                <p>
                    <span>{{HTML::image('assets/img/logos/' . $product->provider . '_logo.jpg', 'provider: ' . $product->provider, ['style' => 'width:70px;height:20px;'])}}</span>
